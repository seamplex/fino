...
[Fino](https://www.seamplex.com/fino) is a free and open source tool released under the terms of the [GPLv3+](#licensing) that uses the finite-element method to solve
...
MESH FILE_PATH tensile-test.msh  DIMENSIONS 3 # mesh file in Gmsh format (either version 2.2 or 4)
...
# print the maxium Von Mises and displacement (otherwise output will be null)
