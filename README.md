...
It is particularly designed to handle complex dependance of material properties (i.e. temperature-dependant properties). It can also perform parametric or optimization runs. The domain over which the problem is solved should be a grid generated by [Gmsh](http://geuz.org/gmsh/). The material properties and boundary conditions may involve arbitrary dependence of space associated to physical entities defined in the mesh. 
...
Fino is copyright (C) 2014-2018 Jeremy Theler  
